...
//******************************************************************************
    ...
    var scwBaseYear        = scwDateNow.getFullYear()-16;
    ...
    document.writeln(
        ...
        '<style type="text/css">'                                       +
            ...
            'td.scwCellsExMonth         {background-color:  #6666CC;'   +
             ...
             function scwSetOutput(scwOutputDate) 
             {
                 ...
                 if (setNotClose == 0)
                    if (document.getElementById('currentPage')) {
                        ...
                        //document.viewform.submit();
                       // console.log(scwOutputDate);
                        //window.location.href="/scheduleView?ffromdate"+scwOutputDate;
                        //07 Jan 2021
                        //Thu Jan 07 2021 12:00:00 GMT+0530 (India Standard Time)
                        //console.log(scwOutputDate);
                        var get_date = scwOutputDate.toString().split(' ');
                        var new_date = get_date[2]+" "+get_date[1]+" "+get_date[3];
                        window.location.href="scheduleView/?ffromdate="+new_date;
