...
tinymce.PluginManager.add('responsivefilemanager', function(editor) {
	...
	function openmanager() {
		...
		const fileUrl = '/acesys'+editor.settings.external_filemanager_path+'dialog.php?type=4&descending='+descending+sort_by+fldr+crossdomain+'&lang='+editor.settings.language+'&akey='+akey;
