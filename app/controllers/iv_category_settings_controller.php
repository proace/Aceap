...

{
	...
	function save() {
		...
		if($this->data['Settings']['description1']['order'] == -1
			...
			&& $this->data['Settings']['sub_category_id']['order'] == -1
		...
		$query = "
			...
			VALUES($id, 'sub_category_id', '".$this->data['Settings']['sub_category_id']['alias']."', '".$this->data['Settings']['sub_category_id']['name']."', ".$this->data['Settings']['sub_category_id']['order'].");
		";			
