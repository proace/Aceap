...
//var_dump($roleID); die;
...

		{
			...
			$menu = array(
				...
				'tabs' => array('Bookings','Inventory','CC Reports','Other Reports','Admin','Techs','Payroll','Call Center'),
...
//	$menu['10']['img'] = 'icon-lg-back.png',
	...
	$menu['10']['img'] = 'icon-lg-card.png',*/
		...
		elseif ($roleID == 6)	// ADMINISTRATORS (OFFICE ADMINS)
		{
			$menu = array(
				'tabs' => array('Bookings','Inventory','Reports','Admin','Techs'),
				'content' =>
				array(
					array(
						array(
...
/*						array(
					...
					array(
						...
						array(
							'name' => 'Inventory',
							'url' => BASE_URL.'/iv_inventories/index',
							'img' => 'icon-lg-customers.png'
						)
					)
				)
			...
			$menu = array(
				...
				'content' => array(
					array(
						...
						array(
							'name' => 'Hot List',
							'url' => 'http://acecare.ca/acesys/index.php/calls/callbacks',
							'onclick' => 'void(0)',
							//'onclick' => 'opencb()',
							'img' => 'icon-lg-callback.png',
							'target' => '_top'
