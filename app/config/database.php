...
class DATABASE_CONFIG
{
	...
	var $default = array('driver' => 'mysql',								
								...
								// 'login' => 'root',
								// 'password' => '',
								// 'database' => 'acecare-test',
								'host' => 'localhost',
								'login' => 'hvacproz_acesys',
								'password' => 'Iw+&Sm]=otV7',
								'database' => 'hvacproz_acesys', //whytecl_acesys is the live database acesys_demo
								
								'prefix' => 'ace_rp_'
								);
	
	var $vicidial = array('driver' => 'mysql',								
								'host' => '69.31.184.162',
								'login' => 'cron',
								'password' => '1234',
								'database' => 'asterisk', 
